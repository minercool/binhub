...
require_once '../../backend/adminController/getStatus.php';
?>
<!DOCTYPE html>
              ...
              <table class="w-full whitespace-no-wrap">
                <thead>
                  <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                    ...
                    <th class="px-4 py-3">Sold items</th>
                    ...
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        ...
                        <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                          <img class="object-cover w-full h-full rounded-full" src="../assets/img/user.png" alt="" />
                          <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                        </div>
                        <div>
                          <p class="font-semibold">Username</p>
                          <img style="height: 10px;" src="../assets/img/flags/tn.png" alt="">
                        </div>
                      </div>
                    </td>
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          <p class="font-semibold">Username</p>
                          <img style="height: 10px;" src="../assets/img/flags/es.png" alt="">
                        </div>
                      </div>
                    </td>
                    <td class="px-4 py-3 text-sm">
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        ...
                        <div>
                          <p class="font-semibold">Username</p>
                          <img style="height: 10px;" src="../assets/img/flags/fr.png" alt="">
                        </div>
                      </div>
                    </td>
                    <td class="px-4 py-3 text-sm">
