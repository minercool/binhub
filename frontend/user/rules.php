                ...
                <div class="container px-6 mx-auto grid">
                    ...
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        ...
                        <ul class="text-sm text-gray-600 dark:text-gray-400">
                            <li>
                                • We only accept Bitcoin . If you using pm or wmz, please do exchange to bitcoin
                            </li>
                            <li>
                                • Your balance will be updated automatic when your fund got 1 confirmation on bitcoin
                                network.
                            </li>
                        </ul>
                        <br>
                        ...
                        <ul class="text-sm text-gray-600 dark:text-gray-400">
                            <li>
                                • Our service is not responsible for card holder info: Address, city, state, zip, phone,
                                dob, ssn, mmn, name and etc...
                            </li>
                            <li>
                                • It is extremely necessaary to explain Your problem in ticket system with maximum
                                details
                            </li>
                            <li>
                                • Our service may BAN your account with follwing reasons: Cheating, Rude ticket request,
                                Potential Hack, Ticket flood and any other suspicious activity
                            </li>
                            <li>
                                • If you want to buy large quantities, please contact us via ticket (support>ticket).
                            </li>
                            <li>
                                • Service DO NOT provide refund for cards marked as 'valid' on checker. Maybe cards not
                                enough balance to spend or killed by checkers . We not control it !
                            </li>
                            <li>
                        ...
                        <ul class="text-sm text-gray-600 dark:text-gray-400">
                            <li>you need 100$ for become a seller (you need to add 100$ to your balance and click to
                                become
                                a seller )</li>
                            <li>Our service DO NOT provide moneyback from account balance</li>
                            <li>Our service may BAN your account with follwing reasons: Cheating, Hign Invalid Rate,
                                Rude
                                ticket request, Potential Hack, Ticket flood and any other suspicious activity</li>
                            <li>Terms may be updated or changed in future...</li>
                        </ul>
                    </div>
                </div>
            </main>
